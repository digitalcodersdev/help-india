...
import useInitializeAds from './src/customHooks/useInitializeAds';
...
import adConstants from './src/constants/adConstants';
...
const App = () => {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <ImageBackground
        source={require('./src/assets/images/back1.jpg')}
